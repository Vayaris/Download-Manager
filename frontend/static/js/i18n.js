...
const TRANSLATIONS = {
  en: {
    ...
    signal_deploy_hint: "Requires Docker. Runs signal-cli-rest-api on this machine.",
  ...
  fr: {
    ...
    signal_deploy_hint: "Nécessite Docker. Lance signal-cli-rest-api sur cette machine.",
