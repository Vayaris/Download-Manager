...
const TRANSLATIONS = {
  en: {
    ...
    smb_subtitle: "Mount network shares (CIFS/SMB) as download destinations. Requires cifs-utils on the server.",
    smb_empty: "No shares configured",
    smb_name: "Name",
    smb_name_hint: "Identifier — used as mount point: /mnt/smb/&lt;name&gt;",
    smb_name_placeholder: "media",
    smb_host: "Host / IP",
  ...
  fr: {
    ...
    smb_subtitle: "Montez des partages réseau (CIFS/SMB) comme destinations de téléchargement. Nécessite cifs-utils sur le serveur.",
    smb_empty: "Aucun partage configuré",
    smb_name: "Nom",
    smb_name_hint: "Identifiant — utilisé comme point de montage : /mnt/smb/&lt;nom&gt;",
    smb_name_placeholder: "media",
    smb_host: "Hôte / IP",
