...
const TRANSLATIONS = {
  en: {
    ...
    signal_btn_reset: "Reset Signal",
    signal_reset_confirm: "Remove Signal configuration and stop the container?",
    signal_reset_done: "Signal configuration removed",
  ...
  fr: {
    ...
    signal_btn_reset: "Réinitialiser Signal",
    signal_reset_confirm: "Supprimer la configuration Signal et arrêter le container ?",
    signal_reset_done: "Configuration Signal supprimée",
