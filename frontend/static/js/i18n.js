...
const TRANSLATIONS = {
  en: {
    ...
    plex_token_help: "Open Plex Web, play any media, click the three-dot menu, choose Get Info, then View XML. Copy the value after X-Plex-Token= in the URL.",
    plex_btn_test: "Test",
    plex_btn_save: "Save",
  ...
  fr: {
    ...
    plex_token_help: "Ouvrez Plex Web, lancez n'importe quel média, cliquez sur le menu à trois points, choisissez Obtenir des infos, puis Voir XML. Copiez la valeur après X-Plex-Token= dans l'URL.",
